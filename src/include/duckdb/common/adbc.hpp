...
struct AdbcDriver {
	...
	AdbcStatusCode (*ConnectionSqlExecute)(struct AdbcConnection *, const char *, struct AdbcStatement *,
	                                       struct AdbcError *);
	...
	AdbcStatusCode (*ConnectionGetTables)(struct AdbcConnection *, const char *, const char *, const char *,
	                                      const char **, struct AdbcStatement *, struct AdbcError *);
	...
	AdbcStatusCode (*StatementBind)(struct AdbcStatement *, struct ArrowArray, struct AdbcError *);
