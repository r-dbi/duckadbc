...
#include "duckadbc_types.hpp"
#include "cpp11/declarations.hpp"
#include <R_ext/Visibility.h>

// connection.cpp
duckdb::conn_eptr_t rapi_connect(duckdb::db_eptr_t db);
extern "C" SEXP _duckadbc_rapi_connect(SEXP db) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_disconnect(SEXP conn) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_startup(SEXP dbdir, SEXP readonly, SEXP configsexp) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_shutdown(SEXP dbsexp) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_register_df(SEXP conn, SEXP name, SEXP value, SEXP integer64, SEXP overwrite, SEXP experimental) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_unregister_df(SEXP conn, SEXP name) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_register_arrow(SEXP conn, SEXP name, SEXP export_funs, SEXP valuesexp) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_unregister_arrow(SEXP conn, SEXP name) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_expr_reference(SEXP name, SEXP table) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_expr_constant(SEXP val) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_expr_function(SEXP name, SEXP args) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_expr_set_alias(SEXP expr, SEXP alias) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_expr_tostring(SEXP expr) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_from_df(SEXP con, SEXP df, SEXP experimental) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_filter(SEXP rel, SEXP exprs) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_project(SEXP rel, SEXP exprs) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_aggregate(SEXP rel, SEXP groups, SEXP aggregates) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_order(SEXP rel, SEXP orders) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_inner_join(SEXP left, SEXP right, SEXP conds) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_union_all(SEXP rel_a, SEXP rel_b) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_limit(SEXP rel, SEXP n) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_distinct(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_to_df(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_tostring(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_explain(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_alias(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_set_alias(SEXP rel, SEXP alias) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_sql(SEXP rel, SEXP sql) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_names(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_to_altrep(SEXP rel) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_rel_from_altrep_df(SEXP df) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_df_is_materialized(SEXP df) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_release(SEXP stmt) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_get_substrait(SEXP conn, SEXP query) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_get_substrait_json(SEXP conn, SEXP query) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_prepare_substrait(SEXP conn, SEXP query) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_prepare_substrait_json(SEXP conn, SEXP json) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_prepare(SEXP conn, SEXP query) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_bind(SEXP stmt, SEXP params, SEXP arrow, SEXP integer64) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_execute_arrow(SEXP qry_res, SEXP chunk_size) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_record_batch(SEXP qry_res, SEXP chunk_size) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_execute(SEXP stmt, SEXP arrow, SEXP integer64) {
  BEGIN_CPP11
...
extern "C" SEXP _duckadbc_rapi_ptr_to_str(SEXP extptr) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_duckadbc_rapi_bind",                   (DL_FUNC) &_duckadbc_rapi_bind,                   4},
    {"_duckadbc_rapi_connect",                (DL_FUNC) &_duckadbc_rapi_connect,                1},
    {"_duckadbc_rapi_df_is_materialized",     (DL_FUNC) &_duckadbc_rapi_df_is_materialized,     1},
    {"_duckadbc_rapi_disconnect",             (DL_FUNC) &_duckadbc_rapi_disconnect,             1},
    {"_duckadbc_rapi_execute",                (DL_FUNC) &_duckadbc_rapi_execute,                3},
    {"_duckadbc_rapi_execute_arrow",          (DL_FUNC) &_duckadbc_rapi_execute_arrow,          2},
    {"_duckadbc_rapi_expr_constant",          (DL_FUNC) &_duckadbc_rapi_expr_constant,          1},
    {"_duckadbc_rapi_expr_function",          (DL_FUNC) &_duckadbc_rapi_expr_function,          2},
    {"_duckadbc_rapi_expr_reference",         (DL_FUNC) &_duckadbc_rapi_expr_reference,         2},
    {"_duckadbc_rapi_expr_set_alias",         (DL_FUNC) &_duckadbc_rapi_expr_set_alias,         2},
    {"_duckadbc_rapi_expr_tostring",          (DL_FUNC) &_duckadbc_rapi_expr_tostring,          1},
    {"_duckadbc_rapi_get_substrait",          (DL_FUNC) &_duckadbc_rapi_get_substrait,          2},
    {"_duckadbc_rapi_get_substrait_json",     (DL_FUNC) &_duckadbc_rapi_get_substrait_json,     2},
    {"_duckadbc_rapi_prepare",                (DL_FUNC) &_duckadbc_rapi_prepare,                2},
    {"_duckadbc_rapi_prepare_substrait",      (DL_FUNC) &_duckadbc_rapi_prepare_substrait,      2},
    {"_duckadbc_rapi_prepare_substrait_json", (DL_FUNC) &_duckadbc_rapi_prepare_substrait_json, 2},
    {"_duckadbc_rapi_ptr_to_str",             (DL_FUNC) &_duckadbc_rapi_ptr_to_str,             1},
    {"_duckadbc_rapi_record_batch",           (DL_FUNC) &_duckadbc_rapi_record_batch,           2},
    {"_duckadbc_rapi_register_arrow",         (DL_FUNC) &_duckadbc_rapi_register_arrow,         4},
    {"_duckadbc_rapi_register_df",            (DL_FUNC) &_duckadbc_rapi_register_df,            6},
    {"_duckadbc_rapi_rel_aggregate",          (DL_FUNC) &_duckadbc_rapi_rel_aggregate,          3},
    {"_duckadbc_rapi_rel_alias",              (DL_FUNC) &_duckadbc_rapi_rel_alias,              1},
    {"_duckadbc_rapi_rel_distinct",           (DL_FUNC) &_duckadbc_rapi_rel_distinct,           1},
    {"_duckadbc_rapi_rel_explain",            (DL_FUNC) &_duckadbc_rapi_rel_explain,            1},
    {"_duckadbc_rapi_rel_filter",             (DL_FUNC) &_duckadbc_rapi_rel_filter,             2},
    {"_duckadbc_rapi_rel_from_altrep_df",     (DL_FUNC) &_duckadbc_rapi_rel_from_altrep_df,     1},
    {"_duckadbc_rapi_rel_from_df",            (DL_FUNC) &_duckadbc_rapi_rel_from_df,            3},
    {"_duckadbc_rapi_rel_inner_join",         (DL_FUNC) &_duckadbc_rapi_rel_inner_join,         3},
    {"_duckadbc_rapi_rel_limit",              (DL_FUNC) &_duckadbc_rapi_rel_limit,              2},
    {"_duckadbc_rapi_rel_names",              (DL_FUNC) &_duckadbc_rapi_rel_names,              1},
    {"_duckadbc_rapi_rel_order",              (DL_FUNC) &_duckadbc_rapi_rel_order,              2},
    {"_duckadbc_rapi_rel_project",            (DL_FUNC) &_duckadbc_rapi_rel_project,            2},
    {"_duckadbc_rapi_rel_set_alias",          (DL_FUNC) &_duckadbc_rapi_rel_set_alias,          2},
    {"_duckadbc_rapi_rel_sql",                (DL_FUNC) &_duckadbc_rapi_rel_sql,                2},
    {"_duckadbc_rapi_rel_to_altrep",          (DL_FUNC) &_duckadbc_rapi_rel_to_altrep,          1},
    {"_duckadbc_rapi_rel_to_df",              (DL_FUNC) &_duckadbc_rapi_rel_to_df,              1},
    {"_duckadbc_rapi_rel_tostring",           (DL_FUNC) &_duckadbc_rapi_rel_tostring,           1},
    {"_duckadbc_rapi_rel_union_all",          (DL_FUNC) &_duckadbc_rapi_rel_union_all,          2},
    {"_duckadbc_rapi_release",                (DL_FUNC) &_duckadbc_rapi_release,                1},
    {"_duckadbc_rapi_shutdown",               (DL_FUNC) &_duckadbc_rapi_shutdown,               1},
    {"_duckadbc_rapi_startup",                (DL_FUNC) &_duckadbc_rapi_startup,                3},
    {"_duckadbc_rapi_unregister_arrow",       (DL_FUNC) &_duckadbc_rapi_unregister_arrow,       2},
    {"_duckadbc_rapi_unregister_df",          (DL_FUNC) &_duckadbc_rapi_unregister_df,          2},
    {NULL, NULL, 0}
};
}
...
extern "C" attribute_visible void R_init_duckadbc(DllInfo* dll){
